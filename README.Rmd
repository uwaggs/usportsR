...
<!-- badges: start -->
[![downloads](https://cranlogs.r-pkg.org/badges/grand-total/usportsR)](https://cran.r-project.org/package=usportsR)  [![Version-Number](https://img.shields.io/github/r-package/v/uwaggs/usportsR?label=usportsR)](https://github.com/uwaggs/usportsR) [![Lifecycle: stable](https://img.shields.io/badge/lifecycle-stable-green.svg)](https://lifecycle.r-lib.org/articles/stages.html#stable)
...
You can install the CRAN version of [**`usportsR`**](https://CRAN.R-project.org/package=usportsR) with:
...
Please refer to the package vignette for more information on how to use this library. For those who prefer to program in Python, [usportspy](https://github.com/uwaggs/usportspy/wiki) has complete function parity with this package.
